...
function isInteger(n) {
    // Побитовые операторы работают только с 32-битными целыми числами
    // Если n целое, то n | 0 вернет n
    return (n | 0) === n;
}
...
function deepEqual(firstObject, secondObject) {
    ...
    // Обработка NaN (NaN !== NaN по спецификации, но для deepEqual должны быть равны)
